                ...
                [
                    ...
                    'buttons' => [
                        ...
                        'update' => function ($url, $model, $key) {
                            return Html::a("<i class='fa fa-edit'></i>", ["update", "id" => $model->id], ["class" => "btn btn-warning", "title" => "Edit Data"]);
                        },
                    ...
                    'contentOptions' => ['nowrap' => 'nowrap', 'style' => 'text-align:center;width:170px']
                ],
                'name',
            ],
        ]); ?>
